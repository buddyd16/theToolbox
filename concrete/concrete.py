...
def web_tbeam():
    ...
    return render_template('concrete/tbeam.html', form=form, beam=beam, web_beam=web_tbeam)
...
def web_pt_point():
    ...
    return render_template('concrete/pt_profile.html',form=form, result=e_prime)
...
def web_aci_unit_width():
    ...
    if request.method == 'POST':
        ...
        results, detailed_results, warning = cip_calc.aci_unit_width_section(form)
    ...
    return render_template('concrete/aci_unit_width.html', form=form, result=results,detailed=detailed_results, warning=warning)

@concrete_bp.route('/aci_development')
def aci_development_web():

    return render_template("concrete/aci_development.html")

@concrete_bp.route('/aci_corbel')
def aci_corbel_web():

    return render_template("concrete/aci_corbel.html")